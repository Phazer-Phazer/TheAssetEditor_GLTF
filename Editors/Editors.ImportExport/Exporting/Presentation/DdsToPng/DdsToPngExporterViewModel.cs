...
namespace Editors.ImportExport.Exporting.Presentation.DdsToPng
{
    internal partial class DdsToPngExporterViewModel : ObservableObject, IExporterViewModel, IViewProvider<DdsToPngView>
    {
        ...
        {
            var settings = new RmvToGltfExporterSettings(new List<PackFile>() { exportSource }, new List<PackFile>(),  outputPath, ExportTextures, ConvertMaterialTextureToBlender, ConvertNormalTextureToBlue, ExportAnimations);
